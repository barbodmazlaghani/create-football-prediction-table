...
const RULES = [
  ...
  },
  {
    ...
    desc: "حدس درست نتیجه همراه با گل دقیق یکی از تیم‌ها، یا تفاضل گل دقیق در برد/باخت",
  ...
  },
  {
    ...
    desc: "تیمی که کنار نتیجهٔ مساوی به‌عنوان برندهٔ پنالتی انتخاب می‌شود، انتخاب تیم صعودکننده هم محسوب می‌شود؛ حتی اگر همان تیم در وقت بازی برنده شود. در بازی پنالتی، مساوی غیر‌دقیق + برندهٔ درست ۷ امتیاز و نتیجهٔ دقیق + برندهٔ درست ۱۰+۳ امتیاز دارد.",
