...
const RULES = [
  ...
  },
  {
    ...
    desc: "اگر بازی به پنالتی برسد، حدس مساوی غیر‌دقیق همراه با برندهٔ درست پنالتی ۷ امتیاز دارد. حدس نتیجهٔ دقیق همراه با برندهٔ درست پنالتی ۱۰+۳ امتیاز می‌گیرد. برندهٔ اشتباه پنالتی هیچ امتیاز اضافه‌ای ندارد.",
